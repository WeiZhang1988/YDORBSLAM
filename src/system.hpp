...
class System : public stack_compatible_enable_shared_from_this<System>{
    ...
    System(const std::string& _strVocFile, const std::string& _strConfigurationPath, const eSensor& _enumSensor, const bool& _bUseViewer = true);
    ...
    void saveTrajectoryTUM(const string& _filename);
    // Save keyframe poses in the TUM RGB-D dataset format.
    // This method works for all sensor input.
    // Call first Shutdown()
    // See format details at: http://vision.in.tum.de/data/datasets/rgbd-dataset
    void saveKeyFrameTrajectoryTUM(const string& _filename);
