...
class Viewer{
    public:
    Viewer(std::shared_ptr<System> _sptrSystem, std::shared_ptr<FrameDrawer> _sptrFrameDrawer, std::shared_ptr<MapDrawer> _sptrMapDrawer, std::shared_ptr<Tracking> _sptrTracking, const string& _strConfigurationPath);
